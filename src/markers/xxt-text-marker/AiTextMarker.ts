...
import { AITextMarkerState } from './AiTextMarkerState';
import { MarkerBaseState } from '../../core/MarkerBaseState';

export class AITextMarker extends RectangularBoxMarkerBase {
  /**
   * String type name of the marker type. 
   * 
   * Used when adding {@link MarkerArea.availableMarkerTypes} via a string and to save and restore state.
   */
  public static typeName = 'AITextMarker';

  /**
   * Marker type title (display name) used for accessibility and other attributes.
   */
  public static title = 'AI Text marker';
  /**
  ...
  private readonly DEFAULT_TEXT = "AI text here";
   ...
   */
  public getState(): AITextMarkerState {
    const result: AITextMarkerState = Object.assign({
      color: this.color,
    ...
    result.typeName = AITextMarker.typeName;
  ...
  public restoreState(state: MarkerBaseState): void {
    const textState = state as AITextMarkerState;
    this.color = textState.color;
    this.fontFamily = textState.fontFamily;
    this.padding = textState.padding;
    this.text = textState.text;
    this.strokeColor = textState.strokeColor;
    this.strokeWidth = textState.strokeWidth;
    this.strokeDasharray = textState.strokeDasharray;
    this.opacity = textState.opacity;
    this.createVisual();
